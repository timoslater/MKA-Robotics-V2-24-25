...
public class FConstants {
    static {
        ...
        FollowerConstants.mass = 13.25;

        FollowerConstants.xMovement = 79.4;
        FollowerConstants.yMovement = 63.0;
        ...
        FollowerConstants.headingPIDFCoefficients.setCoefficients(2.1,0,0.01,0);
        FollowerConstants.useSecondaryHeadingPID = false;
        FollowerConstants.secondaryHeadingPIDFCoefficients.setCoefficients(2,0,0.1,0); // Not being used, @see useSecondaryHeadingPID

        FollowerConstants.drivePIDFCoefficients.setCoefficients(0.016,0,0.000005,0.6,0);
